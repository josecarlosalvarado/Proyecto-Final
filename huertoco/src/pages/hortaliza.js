...
export default function Aromaticas() {
  ...
  return (
    <div>
      <h1 className="text-light">Hortalizas</h1>
      <Introduccion />
      <CardPrincipal
        title="Las mejores Hortalizas"
        description="Descubre todas las variedades"
        src="https://marketingcreativo.studio/wp-content/uploads/2021/05/ajo.jpg"
      />

      <div className="mb-2">
        <div className="col">
          <strong className="fs-2">Hortalizas</strong>
        </div>
      </div>
