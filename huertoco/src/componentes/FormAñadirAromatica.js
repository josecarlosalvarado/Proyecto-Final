...
export default function CardPrincipal() {
    ...
    const initialFormState = {name: "", scientific_name: "", family: "", sowing_temperate_climates: "", sow_other_climates: "", harvest: "", flowerpot: "", substrate_fertilizer: "", irrigation: "", light: "", weather: "", difficulty: "", notes: "", properties: "", pests: "", filter_month: ""};
